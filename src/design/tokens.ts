...
export const designSystem = {
  // Color system inspired by Stripe/Notion/Vercel
  colors: {
    primary: {
      50: '#f0f9ff',
      100: '#e0f2fe',
...
export const gradients = {
  ...
  secondary: 'linear-gradient(135deg, #f3f4f6 0%, #ec4899 100%)',
  ...
  border: 'linear-gradient(135deg, rgba(255, 255, 255, 0.2) 0%, rgba(255, 255, 255, 0.1) 100%)',
};
