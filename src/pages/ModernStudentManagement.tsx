    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-6">
          <ModernCard variant="gradient" className="p-4 text-white">
          ...
          <ModernCard variant="gradient" className="p-4 bg-gradient-to-br from-green-600 to-emerald-600 text-white">
            <div className="flex items-center justify-between">
              <div>
          ...
          <ModernCard variant="gradient" className="p-4 bg-gradient-to-br from-blue-600 to-purple-600 text-white">
            <div className="flex items-center justify-between">
              <div>
          ...
          <ModernCard variant="gradient" className="p-4 bg-gradient-to-br from-orange-600 to-red-600 text-white">
            <div className="flex items-center justify-between">
              <div>
          ...
          <ModernCard variant="gradient" className="p-4 bg-gradient-to-br from-purple-600 to-pink-600 text-white">
            <div className="flex items-center justify-between">
              <div>
                    ...
                    <tr key={student.id} className="border-b border-gray-200 hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center space-x-2">
                          ...
                          <ModernButton variant="ghost" size="sm" className="text-red-600 hover:text-red-700">
