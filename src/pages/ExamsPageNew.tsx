        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <Card className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl p-6 shadow-lg">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <div className="text-lg font-bold text-white">Study Materials</div>
                <div className="text-white/80 text-sm">Access resources</div>
              </div>
            </div>
          </Card>
          ...
          <Card className="bg-gradient-to-r from-green-600 to-green-700 rounded-2xl p-6 shadow-lg">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <div className="text-lg font-bold text-white">Practice Tests</div>
                <div className="text-white/80 text-sm">Take mock exams</div>
              </div>
            </div>
          </Card>
          ...
          <Card className="bg-gradient-to-r from-purple-600 to-purple-700 rounded-2xl p-6 shadow-lg">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <div className="text-white/80 text-sm">View grades</div>
              </div>
            </div>
          </Card>
        </div>
