...
import { Card, CardContent } from '@/components/premium/Card';
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  >
                    <svg className="w-5 h-5 mr-2" viewBox="0 0 24 24">
                      <path fill="#4285F4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25-.07-1.11-.35-2.08-.88-2.92-1.57-.41-.35-.88-.61-1.38-.61-1.06 0-1.92.61-2.56 1.61-.41.43-.69.89-.69-1.46 0-1.27.47-2.34 1.53-2.34 1.06 0 1.92.47 2.56 1.53.41.43.69.89.69 1.46 0 1.27-.47 2.34-1.53 2.34-1.06 0-1.92-.47-2.56-1.53-.41-.43-.69-.89-.69-1.46 0-1.27.47-2.34-1.53-2.34-1.06 0-1.92.47-2.56 1.53-.41.43-.69.89-.69 1.46 0 1.27.47 2.34 1.53 2.34 1.06 0 1.92-.47 2.56-1.53.41-.43.69-.89.69-1.46 0-1.27-.47-2.34-1.53-2.34z"/>
                    </svg>
                    Google
                  </Button>
                  <Button
