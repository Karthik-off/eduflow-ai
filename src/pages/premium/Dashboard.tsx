...
import { Card, CardHeader, CardContent } from '@/components/premium/Card';
...
const PremiumDashboard = () => {
  ...
  const isAttendanceBelowThreshold = attendanceStats.percentage < ATTENDANCE_THRESHOLD;
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="text-center">
                  <div className={`w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-3 ${
                    ...
                    <Target className={`w-8 h-8 ${isAttendanceBelowThreshold ? 'text-red-600' : 'text-blue-600'}`} />
                  </div>
                  <p className="text-2xl font-bold text-gray-900">{stats.attendanceRate}%</p>
                  <p className={`text-sm font-medium ${attendanceColor}`}>{attendanceStatus}</p>
                  ...
                  {isAttendanceBelowThreshold && (
                    <div className="mt-3 flex items-center justify-center">
                      <div className="flex items-center space-x-1 bg-red-100 dark:bg-red-900/30 px-2 py-1 rounded-full">
                        ...
                        <span className="text-xs font-medium text-red-600 dark:text-red-400">Below Threshold</span>
                      </div>
                    </div>
                  )}
                </div>
